...
pub fn scaffold() -> Result<()> {
	...
	if !setup_path.exists() {
		...
		fs::write(&setup_path, content).context("Writing setup.surql")?;
	}
...
pub const SETUP_FILE_HEADER: &str = "-- This file is generated by SurrealKit. Do not edit it manually.\n-- To regenerate, run: surrealkit setup\n\n";
